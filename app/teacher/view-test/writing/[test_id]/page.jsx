...
export default function ViewWritingTestPage({ params }) {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <ViewTestHeader
        title={previewData?.title || 'Writing Test'}
        subtitle="Check prompt clarity, support content, and attached media before assigning."
        skillLabel="Writing"
        status={status}
        showViewFeedback
        onViewFeedback={() => router.push(`/teacher/view-test/writing/${test_id}/feedback`)}
        showDelete
        deleting={deleting}
