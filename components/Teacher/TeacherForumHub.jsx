...
export default function TeacherForumHub() {
  ...
  const yearOptions = useMemo(() => {
    ...
    return ['all', String(currentYear), String(currentYear - 1), String(currentYear - 2)];
  }, []);
    ...
    const fetchTests = async () => {
      ...
      try {
        ...
        const filteredByYear =
          filters.year === 'all'
            ? results
            : results.filter((test) => extractYear(test.created_at) === filters.year);

        if (!active) {
          return;
        }

        setTests(filteredByYear);
          ...
          >
            <Box sx={{ mb: 2.5 }}>
              ...
              <Typography color="text.secondary">
                Browse all published tests and open each forum to view student discussions.
              </Typography>
            </Box>
                      ...
                      <CardContent sx={{ p: 0, '&:last-child': { pb: 0 } }}>
                        ...
                        <Box sx={{ display: 'flex', gap: 1 }}>
                          <Button
                            ...
                            size="small"
                            variant="outlined"
                            onClick={() => router.push(`/teacher/forum/${test.id}`)}
